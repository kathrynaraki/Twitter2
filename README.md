...
Twitter 2 is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
## Notes
I had challenges adding new features to my app because the bigger it got the harder it was to organize and not break things.
